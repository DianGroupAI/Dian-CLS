...
def vgg19_bn(pretrained: bool = False, progress: bool = True, num_classes: int= 2, **kwargs: Any) -> VGG:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _vgg('vgg19_bn', 'E', True, pretrained, progress, num_classes=num_classes, **kwargs)
